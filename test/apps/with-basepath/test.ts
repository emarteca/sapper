...
var TIMING_TEMP_VAR_AUTOGEN102__RANDOM = perf_hooks.performance.now();
 await  r.sapper.start();
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/with-basepath/test.ts& [73, 2; 73, 25]& TEMP_VAR_AUTOGEN102__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN102__RANDOM));
