...
var TIMING_TEMP_VAR_AUTOGEN58__RANDOM = perf_hooks.performance.now();
 await  r.sapper.start();
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/encoding/test.ts& [38, 2; 38, 25]& TEMP_VAR_AUTOGEN58__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN58__RANDOM));
