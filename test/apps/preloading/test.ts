...
var TIMING_TEMP_VAR_AUTOGEN82__RANDOM = perf_hooks.performance.now();
 await  r.sapper.start();
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/preloading/test.ts& [57, 2; 57, 25]& TEMP_VAR_AUTOGEN82__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN82__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN105__RANDOM = perf_hooks.performance.now();
 await  r.sapper.start();
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/preloading/test.ts& [75, 2; 75, 25]& TEMP_VAR_AUTOGEN105__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN105__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN124__RANDOM = perf_hooks.performance.now();
 await  r.sapper.start();
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/preloading/test.ts& [93, 2; 93, 25]& TEMP_VAR_AUTOGEN124__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN124__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN147__RANDOM = perf_hooks.performance.now();
 await  r.sapper.start();
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/preloading/test.ts& [123, 2; 123, 25]& TEMP_VAR_AUTOGEN147__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN147__RANDOM));
