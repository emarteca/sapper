...
var TEMP_VAR_AUTOGEN129__RANDOM_LATER =  r.sapper.start();

		
await r.sapper.prefetchRoutes();
var TIMING_TEMP_VAR_AUTOGEN129__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/basics/test.ts& [101, 2; 101, 25]& TEMP_VAR_AUTOGEN129__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN129__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN129__RANDOM_LATER
...
var TEMP_VAR_AUTOGEN149__RANDOM_LATER =  r.sapper.start();


		
const requests = await r.capture_requests(() => r.sapper.prefetch('b'));
var TIMING_TEMP_VAR_AUTOGEN149__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/basics/test.ts& [130, 2; 130, 25]& TEMP_VAR_AUTOGEN149__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN149__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN149__RANDOM_LATER
...
var TEMP_VAR_AUTOGEN159__RANDOM_LATER =  r.sapper.start();
...
var TIMING_TEMP_VAR_AUTOGEN159__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/basics/test.ts& [156, 2; 156, 25]& TEMP_VAR_AUTOGEN159__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN159__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN159__RANDOM_LATER
...
var TEMP_VAR_AUTOGEN167__RANDOM_LATER =  r.sapper.start();
...
var TIMING_TEMP_VAR_AUTOGEN167__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/basics/test.ts& [180, 2; 180, 25]& TEMP_VAR_AUTOGEN167__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN167__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN167__RANDOM_LATER
...
var TEMP_VAR_AUTOGEN173__RANDOM_LATER =  r.sapper.start();
...
var TIMING_TEMP_VAR_AUTOGEN173__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/basics/test.ts& [213, 2; 213, 25]& TEMP_VAR_AUTOGEN173__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN173__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN173__RANDOM_LATER
...
var TEMP_VAR_AUTOGEN180__RANDOM_LATER =  r.sapper.start();
...
var TIMING_TEMP_VAR_AUTOGEN180__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/basics/test.ts& [236, 2; 236, 25]& TEMP_VAR_AUTOGEN180__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN180__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN180__RANDOM_LATER
...
var TEMP_VAR_AUTOGEN185__RANDOM_LATER =  r.sapper.start();
...
var TIMING_TEMP_VAR_AUTOGEN185__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/basics/test.ts& [259, 2; 259, 25]& TEMP_VAR_AUTOGEN185__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN185__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN185__RANDOM_LATER
...
var TEMP_VAR_AUTOGEN198__RANDOM_LATER =  r.sapper.start();
...
var TIMING_TEMP_VAR_AUTOGEN198__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/basics/test.ts& [365, 2; 365, 25]& TEMP_VAR_AUTOGEN198__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN198__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN198__RANDOM_LATER
