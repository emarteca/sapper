...
var TEMP_VAR_AUTOGEN101__RANDOM =  puppeteer.launch({ args: ['--no-sandbox'] });
...
var TIMING_TEMP_VAR_AUTOGEN101__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN101__RANDOM = await  TEMP_VAR_AUTOGEN101__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/AppRunner.ts& [72, 2; 72, 68]& TEMP_VAR_AUTOGEN101__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN101__RANDOM));
 this.browser =   AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN101__RANDOM
