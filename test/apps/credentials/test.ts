...
var TEMP_VAR_AUTOGEN113__RANDOM_LATER =  r.sapper.start();
...
var TIMING_TEMP_VAR_AUTOGEN113__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/sapper/test/apps/credentials/test.ts& [82, 2; 82, 25]& TEMP_VAR_AUTOGEN113__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN113__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN113__RANDOM_LATER
